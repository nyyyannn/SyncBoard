...
const { createDoc, getDocById, getAllDocs, inviteCollaborator, deleteDocById, getDocVersions } = require("../controllers/docs-controller");
...
router.get("/:id/versions",authMiddleware,getDocVersions);
